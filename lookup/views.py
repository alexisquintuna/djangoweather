...
def home(request):
    ...
    if request.method == "POST":
        ...
        api_request = requests.get("https://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=" + zipcode + "&distance=5&API_KEY=1ACF74DB-CE2C-4B15-8366-A3035D2FB436")
        ...
        if api[0]['Category']['Name'] == "Good":
            ...
            category_description = "(101-150) Although general public is not likely to be affected at this AQI range, people with lung disease, older adults and children are at greater risk from the presence of particles in the air."
            category_color = "usg"            
        ...
        api_request = requests.get("https://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=43204&distance=5&API_KEY=1ACF74DB-CE2C-4B15-8366-A3035D2FB436")
